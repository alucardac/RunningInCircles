...
public static class Save
{
	...
	public class MapInfo
	{
		...
		{	//Saves this current class to the given file path.
		...
		public static MapInfo Load(string path)
		{	//Loads the current class from the given path.
		...
		public static MapInfo LoadFromText(string text)
		{	//Instead of loading from a file, what if we just gave the serializer the raw data from a string?
